...
function renderNotes() {
  ...
  notes.forEach((note) => {
    ...
    //insertAdjacentHTML metodu belirli bir öğeyi bir Html elemanına
    //  göre sıralı şekilde eklemek için kullanılır.
    // Bu metot hangi konuma ekleme yapılacak ve hangi eleman eklenecek bunu
    // belirtmemizi ister
